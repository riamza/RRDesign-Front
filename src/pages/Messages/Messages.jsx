...
const Messages = () => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      const data = isAdmin
        ? await api.contactMessages.getAll()
        : await api.contactMessages.getMyHistory();
              ...
              <>
                <div className="message-viewer-header">
                  ...
                  <div className="message-actions">
                    <button
                      className="btn-icon"
                      title={t("messages.star")}
                      onClick={handleStar}
                    >
                      <Star
                        size={18}
                        className={selectedMessage.starred ? "star-icon" : ""}
                      />
                    </button>
                    <button
                      className="btn-icon"
        ...
        <div className="modal-overlay" onClick={handleCloseComposeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Mesaj Nou</h2>
              <button className="modal-close" onClick={handleCloseComposeModal}>
                ×
              </button>
            </div>
