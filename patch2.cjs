...
function patchMyProjects() {
    let data = fs.readFileSync('e:/RRDesign/Site/Front/src/pages/MyProjects/MyProjects.jsx', 'utf8');
    ...
    fs.writeFileSync('e:/RRDesign/Site/Front/src/pages/MyProjects/MyProjects.jsx', data);
    console.log("Patched MyProjects.jsx");
}

function patchClientProjectDetails() {
    let file = 'e:/RRDesign/Site/Front/src/pages/Dashboard/components/ClientProjectDetails.jsx';
    if (!fs.existsSync(file)) {
        // Checking another path
        file = 'e:/RRDesign/Site/Front/src/pages/MyProjects/ClientProjectDetails.jsx';
        if (!fs.existsSync(file)) {
